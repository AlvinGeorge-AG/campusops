...
- **Blog: ** [`https://builder.aws.com/content/3Id6F3o677yVRRoXjTYJfnnstLb/how-i-built-campusops-with-strands-agents-from-one-sentence-to-a-real-campus-event`](aws-builder)
